...
%D1
%
\addchap{Kongresstag 1}
\addpaper{D1-1}{Ingmar Bauckhage \and Vsevolod Pypenko}{Zusammenarbeit in der Software-Entwicklung}
\addpaper{D1-2}{Adrian Liehner \and Jülf Freudenberger}{Software Reuse}
\addpaper{D1-3}{Fabian Klimpel \and Lukas Epple \and Raphael Sack}{Auswirkungen von SOA}
\addpaper{D1-4}{Gabriel Sperling \and Reinhold Jooß}{Infrastructure as Code}
%
%D2
%
\addchap{Kongresstag 2}
\addpaper{D2-1}{Jonathan Schwab \and Felix Wochele \and Jonas Weis}{Intelligente Werkzeuge SWE}
\addpaper{D2-2}{Jannik Dürr \and Dominic Joas \and Ruben Kalmbach}{Hybride Applikationen}
\addpaper{D2-3}{Alicia Dietrich \and Nick Dürr \and Jan Perthel}{Untersuchung von Web-Usability Prinzipien und Evaluation zweier Webshops}
\addpaper{D2-4}{Niklas Arnold \and Luca Negron-Martinez}{Everything-as-a-Service}
\addpaper{D2-5}{Robin Epple \and Timo Vollert}{Resilienz in Systemarchitekturen}
\addpaper{D2-6}{Fabian Heinl \and Philipp Kremling}{Green IT}
