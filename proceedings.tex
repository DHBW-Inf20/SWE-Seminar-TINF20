...
\includepdf[pagecommand={\thispagestyle{empty}},pages=3-3,noautoscale]{LNI-Startseiten.pdf}
...
\addchap{D2}
\addpaper{D2-1}{vn1 nachnameEins \and vornameZwei nachnameZwei \and vornameDrei nachnameDrei}{kurztitel}
